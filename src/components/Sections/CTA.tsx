...
export default function CTASection() {
  return (
    <section id="cta" className="relative flex flex-col justify-start items-center pointer-events-none pb-0 pt-[20vh]">
      <div className="container mx-auto px-6 z-10 pointer-events-auto flex flex-col items-center justify-center text-center mix-blend-exclusion mb-[20vh] max-w-4xl">
        ...
        <div className="gsap-fade-in opacity-0 flex flex-col md:flex-row justify-center items-center gap-6 mb-12">
          <div className="flex items-center gap-2 text-gray-400 font-inter text-sm bg-white/5 px-6 py-2 rounded-full">
        ...
        <div className="flex flex-col items-center w-full max-w-lg mb-32 mx-auto border-t border-white/10 pt-16">
          ...
          <p className="text-gray-400 font-inter text-sm mb-6">Join our newsletter to receive weekly automation setups.</p>
          <form className="flex w-full relative" onSubmit={(e) => e.preventDefault()}>
            ...
            <input 
              ...
              className="w-full bg-black border border-white/20 rounded-l-lg py-4 pl-12 pr-4 text-white focus:outline-none focus:border-[#00f0ff] transition-colors"
              required
            />
            <button 
              type="submit" 
              className="bg-[#7a00ff] hover:bg-[#5a00ff] text-white px-8 font-orbitron uppercase tracking-wider rounded-r-lg transition-colors flex items-center gap-2 group"
            >
      ...
      {/* Dissolve (Footer) */}
      <footer className="w-full mt-[10vh] border-t border-white/5 pt-12 pb-12 flex flex-col lg:flex-row justify-center lg:justify-between items-center text-xs text-gray-700 font-orbitron z-10 pointer-events-auto mix-blend-exclusion px-12">
